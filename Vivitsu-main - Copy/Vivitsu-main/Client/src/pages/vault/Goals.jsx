      ...
      >
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm txt-dim">
                You need to save {dailyRate.toFixed(1)} ALGO daily to reach your
                goal in {daysLeft} days. You're currently on track to save{" "}
                {(user.totalSaved * 90 / Math.max(1, 45)).toFixed(0)} ALGO.
              </p>
        ...
        <motion.div variants={itemVariants}>
          ...
          {depositHistory.length === 0 ? (
            <div className="p-6 rounded-lg bg-sec border border-[var(--border)] txt-dim">
              No deposits yet. Your next deposit will show up here.
            </div>
          ) : (
                ...
                >
                  <div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold">+{entry.amount} ALGO</div>
                        <div className="text-xs txt-dim">
                          {new Date(entry.date).toLocaleDateString()} â€¢ Streak
                          Day {entry.streakDay}
                        </div>
                      </div>
                    </div>
