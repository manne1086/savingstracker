    ...
    >
      ...
      >
        ...
        <Button
          ...
          variant="default"
          size="default"
          className="px-6 py-3 bg-[var(--btn)] hover:bg-[var(--btn-hover)] text-white rounded-full font-semibold transition-all transform duration-300 shadow-lg hover:shadow-xl"
          style={{}}
        >
          Get started
        </Button>
      ...
      >
        <div className="absolute top-1/4 left-1/4 sm:w-32 h-24 sm:h-32 bg-red-500 rounded-full opacity-10 blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-1/3 right-1/4 w-40 h-40 bg-orange-500 rounded-full opacity-10 blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-36 h-36 bg-rose-500 rounded-full opacity-10 blur-3xl animate-pulse"
