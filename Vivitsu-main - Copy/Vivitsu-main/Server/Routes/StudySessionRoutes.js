...
// Manual hours
router.post("/manual", authMiddleware, createManualSession);
router.get("/manual", authMiddleware, getManualSessions);
router.put("/manual/:id", authMiddleware, updateManualSession);
router.delete("/manual/:id", authMiddleware, deleteManualSession);
router.post("/auto-plan", authMiddleware, createAutoStudyPlan);
